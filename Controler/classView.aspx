<%@ Page Title="" Language="C#" MasterPageFile="admin.master" AutoEventWireup="true"
    CodeFile="classView.aspx.cs" Inherits="class_page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="controlarea ">
        ...
        <p>
            <asp:Button ID="addStudentBtn" runat="server" Text="更新课程信息" OnClick="addStudentBtn_Click" /> &nbsp&nbsp&nbsp
            <asp:Button ID="Button1" runat="server" Text="删除课程" OnClick="Button1_Click" />
        </p>
        <br />
    </div>
</asp:Content>
