...
namespace GS.DAL
{
	...
	/// 数据访问类:classtypeDAL
	/// </summary>
	public partial class classtypeDAL
	{
		public classtypeDAL()
		{}
		#region  Method
		...
		public bool Exists(string id)
		{
			...
			strSql.Append("select count(1) from classType");
		...
		public bool Add(GS.Model.classtype model)
		{
			...
			strSql.Append("insert into classType(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update classType set ");
			if (model.name != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from classType ");
			strSql.Append(" where id"+id+"" );
			int rowsAffected=DbHelperSQL.ExecuteSql(strSql.ToString());
			if (rowsAffected > 0)
			{
		...
		public GS.Model.classtype GetModel(string id)
		{
			...
			strSql.Append(" from classType ");
			strSql.Append(" where id"+id+"" );
			GS.Model.classtype model=new GS.Model.classtype();
